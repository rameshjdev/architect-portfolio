      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        >
          <a href="#home" className="flex items-center group">
            <span className="mr-2 text-teal-400 group-hover:text-teal-300 transition-colors">Lakshmi</span>
            <div className="flex flex-col">
              <span className="text-sm font-light tracking-widest uppercase text-white">Gayathri</span>
              <span className="text-xs text-teal-400/70 tracking-wider">Architect & Designer</span>
            </div>
          </a>
        </motion.div>
        ...
        <nav className="hidden md:flex items-center space-x-1">
          {navItems.map((item, index) => (
            ...
            >
              <a 
                ...
                className={`relative px-5 py-2 rounded-md text-sm uppercase tracking-wider font-medium transition-all duration-300 flex items-center ${
              ...
              >
                ...
                {activeSection === item.name.toLowerCase() && (
                  <motion.span 
                    ...
                    className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-teal-400 to-teal-300"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
          ...
          >
            <a 
              href="#contact" 
              className="px-5 py-2 bg-teal-500 text-white rounded-md hover:bg-teal-400 transition-colors duration-300 shadow-lg shadow-teal-500/20 text-sm font-medium flex items-center"
            >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div 
            ...
            transition={{ duration: 0.3 }}
            className="md:hidden absolute w-full bg-slate-900/98 backdrop-blur-md shadow-xl overflow-hidden border-t border-slate-800/50"
          >
            <nav className="flex flex-col px-6 py-4 space-y-1">
              ...
              {/* Social Media Links */}
              <div className="pt-4 mt-2 border-t border-slate-800/50 flex justify-between">
                <span className="text-xs text-gray-400">Follow Me</span>
